...
data <- read_excel("C:\\Users\\Hp\\Downloads\\NSC-2025.xlsx", sheet="Sheet2")
...
dengan Y adalah rata - rata indeks pembangunan manusia dan X3 adalah persentase Penduduk miskin.

Didapatkan nilai $\hat\beta_0 = 84.2552$ artinya nilai dugaan rataan indeks pembangunan manusia ketika rata-rata persentase penduduk miskin 0 persen adalah 84.2552%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata persentase penduduk miskin $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = 84.2552$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Rata-rata persentase penduduk miskin berubah satu tahun adalah sebesar 0.9377%

Koefisien determinasi yang dihasilkan adalah 0.48314 atau 48,31% artinya keragaman rata rata indeks pembangunan yang dapat dijelaskan oleh persentase penduduk miskin adalah sebesar 48,31%, sisanya yaitu 51,69% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
